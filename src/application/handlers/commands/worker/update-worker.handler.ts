...
export class UpdateWorkerHandler implements ICommandHandler<UpdateWorkerCommand> {
  ...
  async execute(command: UpdateWorkerCommand): Promise<WorkerResponseDto> {
    ...
    return {
      ...
      professionalTitle: updatedWorker.professionalTitle,
      experienceYears: updatedWorker.experienceYears,
      skills: updatedWorker.skills,
      addressStreet: updatedWorker.addressStreet,
      addressCity: updatedWorker.addressCity,
      addressState: updatedWorker.addressState,
      addressZipCode: updatedWorker.addressZipCode,
